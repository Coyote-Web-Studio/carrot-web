        ...
        <div className="px-4 md:px-8 lg:px-48 pb-6 w-full flex justify-center">
            <div className="w-full flex flex-col lg:flex-row lg:items-center lg:justify-center gap-20 md:gap-36 pb-16 pt-7 md:pt-24 md:pb-32">
                <div className="flex flex-col gap-10 flex-1 w-full">
                    ...
                    >
                        <AnimatedText text="Unlock the power of incentivization with Carrot" />
                    </Typography>
                    <div className="flex flex-col gap-14">
                        <Typography variant="lg" data-aos="fade-up">
                            <AnimatedText
                                text="Reimagine the potential of your community with Carrot. Turn aspirations into actions and celebrate every milestone with tailored rewards."
                                speed={10}
                            ></AnimatedText>
                        </Typography>
                        <a
