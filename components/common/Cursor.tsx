    ...
    useEffect(() => {
      document.addEventListener('mousemove', (event : any) => {
        ...
        mainCursor.current.style.transform = 
          `translate3d(${mouseX - mainCursor.current.clientWidth / 2}px, ${mouseY - mainCursor.current.clientHeight / 2}px, 0)`;
  
        mainCursor.current.getElementsByClassName('plus-sign')[0]
          .style.opacity = isClickable ? 1 : 0;

        mainCursor.current.style.mixBlendMode = isClickable ?  'exclusion' : 'normal';
