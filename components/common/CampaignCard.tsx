    ...
    return (
        ...
        >
            <StyledCampaignCard
                ...
                bg={transparentize("0.1", theme.colors.cardBackground)}
                sx={{
                ...
                >
                    <Flex
                        sx={{
                            ...
                            alignItems: "center",
                            borderRight: `0.1rem solid ${theme.colors.textColor}`,
                            width: "7rem",
                        }}
                    >
                        <Box
                    ...
                    <Flex alignItems="center" pl="2rem">
                        <Text
                            as={"p"}
                            fontSize={["1.6rem", null, null, "1.6rem"]}
                            fontWeight={400}
                        >
                            {campaign.heading}
                        </Text>
                ...
                >
                    ...
                    >
                        <Flex justifyContent={"space-between"}>
                            ...
                            <Text as={"p"}>{campaign.rewards}</Text>
                        </Flex>
                        <Flex justifyContent={"space-between"}>
                            <Text as={"p"}>TIME LEFT</Text>
                            <Text as={"p"}>{campaign.timeLeft}</Text>
                        </Flex>
                    </Flex>
                </Flex>
                {/* LINK */}
