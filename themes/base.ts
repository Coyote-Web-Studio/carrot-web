...
const base = {
    ...
    boxSizes: {
        defaultBox: {
            mx: "auto",
            width: ["calc(100vw - 4.8rem)", "60rem", null, "88rem"],
        ...
        expandedBox: {
            position: "absolute",
            height: "100%",
            width: ["calc(100vw)", "calc(72rem + 1px)", null, "100vw"],
            left: ["0", "calc(50% - (72rem / 2) + 2px)", null, "0"],
            [`@media screen and (min-width: ${breakpoints[4]})`]: {
        ...
        heroGridBox: {
            ...
            height: ["calc(2.4rem * 14)", "calc(2.4rem * 18)", null, "44.7rem"],
            width: ["100vw"],
            left: ["0"],
            [`@media screen and (min-width: ${breakpoints[3]})`]: {
                height: "57.6rem",
